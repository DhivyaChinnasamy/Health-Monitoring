      ...
      <tr>
		...
		Statement st,st1,st2,st3,st4;
          ...
          <div align="center">
            ...
            <table width="337" height="303" border="0">
              <tr>
                <td><span class="style26">Tokenization</span></td>
                <td><label>
                  <textarea name="textarea3" rows="6"><%=session.getAttribute("tokens")%></textarea>
                </label></td>
              </tr>
              <tr>
                <td><span class="style26">Stopwords</span></td>
                <td><label>
                  <textarea name="textarea" rows="4"><%=session.getAttribute("stopwords")%></textarea>
                </label></td>
              </tr>
              <tr>
                <td><span class="style26">Terms </span></td>
                <td><label>
                  <textarea name="textarea2" rows="4"><%=session.getAttribute("keyword")%></textarea>
                </label></td>
              </tr>
            </table>
          </div>
